...
from recsys.gcp_integrations.model_registry import upload_model_to_registry, deploy_model_to_endpoint
    ...
    def deploy_endpoint(
        ...
        try:
            ...
            if len(endpoints) > 0:
                ...
                raise RuntimeError(f"Endpoint {endpoint_id} not found. Please ensure it's created in Terraform.")
...
class GCPQueryModel(BaseGCPModel):
    ...
    def save_to_local(self, output_path: str = "query_model") -> str:
        ...
        inference_signatures = query_module.compute_embedding.get_concrete_function(instances_spec)
