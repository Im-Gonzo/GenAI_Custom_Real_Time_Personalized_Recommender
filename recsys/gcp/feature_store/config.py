...
FEATURE_CONFIGS = {
    "transactions": {
        ...
        "feature_columns": ["t_dat", "price", "month_sin", "month_cos"],
    },
    "articles": {
    ...
    "customers": {
        "entity_key": "customer_id",
        "join_keys": [],
        "feature_columns": ["age", "club_member_status", "age_group", "postal_code"],
    },
    "rankings": {
        "entity_key": "customer_id",
        "join_keys": ["article_id"],
        "feature_columns": ["prediction", "label", "rank"],
    },
}


def get_feature_config(
    view_id: str, include_join_keys: bool = True
) -> Dict[str, List[str]]:
    """
